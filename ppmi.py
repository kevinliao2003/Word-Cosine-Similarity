...
class PPMIObject(object):
	""" The main object you will be filling in methods for."""
	...
	def return_ppmi_value(self, target_word, context_word):
		...
		# Hint: This should be a simple lookup in self.PPMI
...
if __name__=="__main__":
	# This main method will not be evaluated by the autograder. Here is some basic usage examples
	# which you can use and expand upon for experimenting locally. You may find it more convenient
	# to interact with the object in the python interpreter or in a notebook.
